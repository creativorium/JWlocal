<?php
/**
 * Title: Mentorship — Thank You (Langkah 3)
 * Slug: jwtrading/mentorship-thankyou
 * Categories: jwtrading
 * Viewport Width: 1400
 * Description: Funnel step 3 — konfirmasi + ekspektasi WhatsApp, VSL, 4 FAQ video, accordion FAQ, payout.
 *
 * Follows the client's revised brief (Page 3, "Mentorship Flow Web Brief"):
...
<!-- wp:jwt/video-embed {"align":"full","narrow":false,"videoUrl":"https://youtu.be/xpcoJccmN0U","label":"video onboarding"} /-->

<!-- wp:jwt/faq-videos {"align":"full","eyebrow":"FAQ","title":"Tonton <mark>Frequently Asked Questions</mark> kami di bawah ini."} -->
<!-- wp:jwt/faq-video-item {"question":"Apakah mentorship ini cocok untuk pemula?","videoUrl":"https://youtu.be/nSHlsXSZafg"} /-->
<!-- wp:jwt/faq-video-item {"question":"Apa yang akan saya dapatkan dari mentorship ini?","videoUrl":"https://youtu.be/aseVWUi4ySg"} /-->
<!-- wp:jwt/faq-video-item {"question":"Berapa lama sampai saya melihat hasil?","videoUrl":"https://youtu.be/HIPBUeAbLnM"} /-->
<!-- wp:jwt/faq-video-item {"question":"Bagaimana proses onboarding-nya?","videoUrl":"https://youtu.be/z25OinlEUPM"} /-->
<!-- /wp:jwt/faq-videos -->
...
<!-- Real payout screenshots — same image set and scroll animation as the
     Testimonials page "Dari Belajar ke Funded Trader" section (brief, Page 3). -->
<!-- wp:jwt/gallery {"align":"full","eyebrow":"Hasil Payout","title":"Payout member kami.","lead":"Hasil nyata dari member yang sudah menjalankan prosesnya.","imageIds":"2501|2502|2503|2504|2505|2506|2507|2508|2509|2510|2511|2512|2513|2514"} /-->
