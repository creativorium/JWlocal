 ...
 * Viewport Width: 1400
 * Description: Halaman sales bootcamp lengkap: hero, stats, tentang, kurikulum, benefit, testimoni, harga, FAQ, CTA preview.
 */
...
<!-- wp:jwt/testimonials {"align":"full","eyebrow":"Hasil Bootcamp","title":"Kata Member Kami","lead":"Sebagian kecil dari ribuan feedback member. Ganti dengan screenshot asli dari testimoni."} -->
...
<!-- wp:jwt/cta {"align":"full","eyebrow":"Investasi Sekali, Akses Selamanya","title":"Join JW Trading Bootcamp","lead":"Rp 1.250.000 — sekali bayar (senilai Rp 3.000.000+). Termasuk video course, komunitas Discord, live review mingguan, dan semua update materi.","buttonText":"Join Sekarang","buttonUrl":"/?add-to-cart=684","promoText":"🔥 20% OFF dengan kode KG29RRJB","note":"Pembayaran aman via Duitku · Tersedia opsi transfer manual"} /-->

<!-- wp:jwt/faq {"align":"full","eyebrow":"Bootcamp FAQ","title":"Pertanyaan yang Sering Ditanya"} -->
...
<!-- wp:jwt/cta {"align":"full","title":"Masih Ragu? Coba Preview Gratis Dulu","lead":"Rasakan cara mengajar kami sebelum memutuskan join — tanpa kartu, tanpa komitmen.","buttonText":"Ambil Preview Gratis","buttonUrl":"/free-content-preview/"} /-->
