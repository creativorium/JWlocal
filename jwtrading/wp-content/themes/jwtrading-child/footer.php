...
<footer class="jwt-footer">
	<div class="jwt-footer__card">
		<div class="jwt-container">
				...
				<div class="jwt-footer__cols">
					...
					<div class="jwt-footer__col">
						...
						<ul class="jwt-footer__menu">
							<li><?php echo jwt_cloak_email( 'info@jwtradingacademy.com' ); // phpcs:ignore WordPress.Security.EscapeOutput -- escaped in helper. ?></li>
						</ul>
			...
			<div class="jwt-footer__disclaimer">
				<p><?php esc_html_e( 'Trading mengandung risiko besar dan sebagian besar trader mengalami kerugian. Konten di situs ini hanya untuk tujuan edukasi, bukan merupakan saran finansial. Kami tidak menyediakan sinyal trading maupun menjamin hasil dari prop firm mana pun.', 'jwtrading' ); ?></p>
				<p><?php esc_html_e( 'Anda bertanggung jawab penuh atas keputusan trading Anda sendiri. Kinerja masa lalu dan testimoni tidak menjamin hasil di masa depan.', 'jwtrading' ); ?></p>
			</div>
...
<div class="jwt-wa-float">
	...
	<?php
	echo jwt_cloak_wa( // phpcs:ignore WordPress.Security.EscapeOutput -- escaped in helper.
		apply_filters( 'jwt/whatsapp_number', '628113931505' ),
		ob_get_clean(),
		'jwt-wa-float__circle',
		__( 'Chat WhatsApp', 'jwtrading' ),
		'Halo! Saya butuh bantuan tentang service JWtrading'
	);
	?>
</div>
